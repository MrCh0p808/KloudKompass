...
> 💡 **Script paths are relative to `.coderwa/` directory**
...
# P0: Security Scan
python .coderwa/skills/vulnerability-scanner/scripts/security_scan.py .

# P1: UX Audit
python .coderwa/skills/frontend-design/scripts/ux_audit.py .

# P3: Lighthouse (requires running server)
python .coderwa/skills/performance-profiling/scripts/lighthouse_audit.py http://localhost:3000

# P4: Playwright E2E (requires running server)
python .coderwa/skills/webapp-testing/scripts/playwright_runner.py http://localhost:3000 --screenshot
```
