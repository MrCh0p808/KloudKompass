...
| ------------- | --------------------------------- | ------------------------------------ |
| **Workspace** | `<workspace-root>/.coderwa/skills/` | Available only in a specific project |
...
```bash
mkdir -p .coderwa/skills/code-review
```
...
```bash
mkdir -p .coderwa/skills/license-header-adder/resources
```

### Step 2: Create the template file

**`.coderwa/skills/license-header-adder/resources/HEADER.txt`**:
...
**`.coderwa/skills/license-header-adder/SKILL.md`**:
