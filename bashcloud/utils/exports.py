...
from bashcloud.core.exceptions import ExportError
...
def generate_default_filename(prefix: str, format: str) -> str:
    ...
    Format: bashcloud_cost_2024-01-15_143022.csv
    """
    from datetime import datetime
    timestamp = datetime.now().strftime("%Y-%m-%d_%H%M%S")
    return f"bashcloud_{prefix}_{timestamp}.{format}"
