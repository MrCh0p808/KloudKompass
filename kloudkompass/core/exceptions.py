# kloudkompass/core/exceptions.py
# -----------------------------
...
# The hierarchy lets me catch KloudKompassError to handle all app errors, or catch
# specific subclasses when finer control is needed.


class KloudKompassError(Exception):
    """
    Base exception for all Kloud Kompass errors.
    
    This as the parent class so that CLI entrypoint can catch any
    Kloud Kompass-related error with a single except clause and display it cleanly.
    """
...
class CLIUnavailableError(KloudKompassError):
    """
...
class CredentialError(KloudKompassError):
    """
...
class PermissionDeniedError(KloudKompassError):
    """
...
class PaginationError(KloudKompassError):
    """
...
class ParsingError(KloudKompassError):
    """
...
class ConfigurationError(KloudKompassError):
    """
    Raised when there is a problem with Kloud Kompass configuration.
...
class DateRangeError(KloudKompassError):
    """
...
class ExportError(KloudKompassError):
    """
