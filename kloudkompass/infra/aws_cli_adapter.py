# kloudkompass/infra/aws_cli_adapter.py
# -------------------------------------
# © 2026 TTox.Tech. Licensed under MIT.
# Kloud Kompass is open-source software.
#
# AWS-specific CLI adapter with Cost Explorer pagination,
# credential validation, and version detection.
...
from kloudkompass.core.exceptions import PaginationError, ParsingError
...
class AWSCLIAdapter(BaseCloudAdapter):
    """
    AWS CLI adapter with built-in pagination and credential checks.
    
    Wraps the `aws` CLI with methods for Cost Explorer queries,
    credential validation, and version detection.
    """
    ...
    def get_cli_version(self) -> Optional[str]:
        ...
        Parses the output of 'aws --version' to extract the version number.
    ...
    def check_credentials(self) -> tuple[bool, Optional[str]]:
        ...
        Calls 'aws sts get-caller-identity' which is a quick way to
    ...
    def check_cost_explorer_access(self) -> tuple[bool, Optional[str]]:
        ...
        Makes a minimal CE call to verify permissions. This catches
        Access Denied errors before the user runs a full query.
        """
        try:
            # Use a 1-day range yesterday to minimize costs
    ...
    def get_cost_explorer_data(
        ...
        Handles all pagination internally, tracking tokens and merging
