...
# Creates a named logger so all kloudkompass modules use the same one
_logger = None


def get_logger(name: Optional[str] = None) -> logging.Logger:
    """
    Get the Kloud Kompass logger.
    ...
    Args:
        name: Optional sublogger name, e.g. "kloudkompass.aws.cost"
    ...
    if _logger is None:
        _logger = logging.getLogger("kloudkompass")
